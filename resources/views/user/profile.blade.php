        ...
        <div class="container  p-6 rounded-md ">
            ...
            <form action="">
                ...
                <div class=" mb-2 space-y-2">
                    ...
                    <input id="nama_lengkap" name="nama_lengkap" value="Mey"
                ...
                <div class="mb-2">
                    ...
                    <input id="alamat" name="alamat" value="Kecamatan Sumberrejo Kabupaten Bojonegoro"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div class="flex space-x-2">
                    <button type="submit"
                        class="mt-5 h-7 xl:w-1/4 w-1/2 bg-primary rounded-lg hover:opacity-50  text-sm   text-white">
                        Simpan Perubahan
                    </button>
                    <button type="submit"
                        class="mt-5 h-7 xl:w-1/4 w-1/2 bg-primary rounded-lg hover:opacity-50  text-sm   text-white">
