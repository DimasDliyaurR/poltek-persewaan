    ...
    <div class=" flex xl:flex-row flex-col xl:space-x-2">
        ...
        <!-- <div class="flex flex-col relative"> -->
            <div class=" flex flex-col xl:w-2/3 w-full  ">
                <div class="p-5 h-48 mb-2  rounded bg-primary relative">
                    <p class=" ">
                        <h4 class="text-5xl font-bold  "> Halo, Alya !</h4>
                        <h4 class="text-xl font-semibold mt-4">Selamat datang di sistem informasi SEWA ASET Politeknik Penerbangan Surabaya</h4>
                ...
                <div class="flex xl:flex-row space-x-2 mb-2 xl:mb-60">
                    <div class=" w-1/2 rounded bg-plaster h-36 p-4 ">
                        <p class="text-lg text-black">
                            Riwayat Pemesanan
                        </p>
                        <h4 class="text-4xl text-black" font-bold ">2</h4>
                    </div>
                    <div class=" w-1/2 p-4 rounded bg-coral  h-36 ">
                        <p class="text-lg text-black  ">
