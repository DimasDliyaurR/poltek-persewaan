            ...
            <div class="container  p-6 rounded-md ">
                ...
                <form action="">
                    ...
                    <div class="mb-2 ">
                        ...
                        <label for="foto_ktp" class=" block mb-2 text-sm font-medium text-gray-900 dark:text-white">Upload
                            Foto KTP</label>
                    ...
                    <div class=" mb-2 ">
                        ...
                        <input id="alamat" name="alamat" placeholder="2023VOUCHER" type="text"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    <div class="mb-2">
                    ...
                    <div class="flex flex-col xl:flex-row lg:flex-row xl:space-x-2 md:space-x-2 sm:space-x-2 mb-2">
                        <div class="mb-2 space-y-2 xl:w-1/2">
                            <label for="password" class=" block mb-2 text-sm font-medium text-gray-900 dark:text-white">No
                                Telephone</label>
