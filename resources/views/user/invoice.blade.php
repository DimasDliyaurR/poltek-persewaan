...
@endsection
@section('button')
<div class="cursor-pointer pt-10 px-10 " title="Kembali ke halaman utama">
    <a href="/invoice">
...
@section('content')
    ...
    <div class="container px-24 mx-auto ">
        <div id="invoice" class="shadow-lg bg-white logoImage relative bg-no-repeat  w-full xl:w-1/2 md:w-1/2 lg:w-1/2 m-auto h-full xl:p-10   ">
