            ...
            <div class="w-full px-4 lg:w-1/2 xl:w-1/3 mb-5">
                <div class="bg-white  rounded-xl shadow-lg overflow-hidden ">
                    <div class="py-8 px-6">
                        <div id="default-carousel" class="relative w-full" data-carousel="slide">
                            ...
                            <div class="relative h-56 overflow-hidden rounded-md ">
                                ...
                                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                    <img src="{{ ('img/penginapan/bad_2.jpg')}}" class="absolute block  w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 shadow-lg rounded-md" alt="gambar 1">
                                </div>
                                <!-- Item 2 -->
                                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                    <img src="{{ ('img/penginapan/lemari_2.jpg')}}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 shadow-lg rounded-md" alt="gambar 2">
                                </div>
                                <!-- Item 3 -->
                                <div class="hidden duration-700 ease-in-out" data-carousel-item> 
                                    <img src="{{ ('img/penginapan/toilet.jpg')}}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 shadow-lg rounded-md" alt="gambar 3">
                                </div>
                                <!-- Item 4 -->
                                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                    <img src="{{ ('img/penginapan/truk_kanan.JPG')}}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 shadow-lg rounded-md" alt="gambar 4">
                                </div>
                            </div>
                            <!-- Slider indicators -->
                        ...
                        <h3>
                        <a href=" {{ route('detailgedung', $gl->id) }} " class="block mb-3 mt-3 font-semibold text-xl text-black hover:text-primary truncate">{{ $gl -> gl_nama}}</a>
                        </h3>
                        <div class="flex mb-2"> 
                        ...
                        <p class="text-xs text-gray-500 mb-1  flex justify-between">*check out 12.00 a.m <span class=" text-black font-bold text-base">{{ $gl->gl_tarif}}</span></p>
