                ...
                <div class="grid col-span-2 md:grid-rows-2 md:grid-flow-col xl:gap-1 gap-2 p-4  w-full">
                    <div class="flex flex-col space-y-1">
                        <div class=" bg-white relative shadow-md p-4 w-full xl:h-20 h-24 xl:ml-36 mx-auto rounded-md ">
                            ...
                            <p class="text-gray-500 xl:text-sm xl:-mt-4 -mt-2 text-xs overflow-hidden">Sisa waktu pembayaran
                            </p>
                        ...
                        <div class="bg-white shadow-md p-4 w-full h-80 xl:ml-36 mx-auto rounded-md">
                            <form action="">
                                <div class="mb-2">
                                    ...
                                    <input type="disabled" placeholder="SPX41397 "
                                        class=" h-10 w-full shadow-md border border-gray-100"><br>
                                </div>
                                <div class="mb-2">
                                ...
                                <button
                                    class=" mt-1 bg-primary text-white text-sm p-1 hover:opacity-30 shadow-md  hover:text-black rounded-sm"><a
                                        href="/invoice">Kirim</a></button>
                            </form>
                            <div class="mt-4 mb-3">
