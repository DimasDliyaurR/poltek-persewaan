...
<div class="bg-plaster">
    <div class="container mx-auto px-24 py-24">
        ...
        <div class="bg-white  mx-auto w-1/2 p-6">
            <div class="relative">
            ...
            <div class=" grid justify-items-center pb-8 pt-6">
                <img src="{{ ('img/centang.png') }}" alt="centang" class="w-20 mb-3">
                <P class="font-bold text-md ">PEMBAYARAN BERHASIL</P>
            </div>
            <div class="flex mb-6">
                <img src="{{ ('img/transportasi/bus.JPG') }} " class="w-48" alt="detail" >
                <div class="ml-4">
