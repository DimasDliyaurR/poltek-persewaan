    ...
    <div class=" bg-plaster py-24">
        <div class=" container  ">
            ...
            <div class="flex xl:flex-row md:flex-row lg:flex-row  flex-col justify-center   space-x-2  ">
                <div class="basis-3/5  bg-white  h-auto  rounded-md p-4 mb-2 ml-2 ">
                    <div class="relative">
                        ...
                        <div class=" flex  gap-2 ">
                            <img src="{{ asset('img/layanan/marching band.jpg') }}" alt="Nature"
                                class="rounded-sm  cursor-pointer shadow-md overflow-hidden w-36  mb-4"
                                onclick="myFunction(this);">
                            <img src="{{ asset('img/layanan/marching band.jpg') }}" alt="Snow"
                                class="rounded-sm  cursor-pointer shadow-md overflow-hidden w-36 mb-4"
                                onclick="myFunction(this);">
                            <img src="{{ asset('img/lab.jpg') }}" alt="Mountains"
                                class="rounded-sm  cursor-pointer shadow-md overflow-hidden w-36 mb-4"
                                onclick="myFunction(this);">
                            <img src="{{ asset('img/layanan/marching band.jpg') }}" alt="Lights"
                                class="rounded-sm  cursor-pointer shadow-md overflow-hidden w-36 mb-4"
                                onclick="myFunction(this);">
                        </div>
                    </div>
                ...
                <div class="basis-1/5 flex-col space-y-2 ">
                    <div class=" bg-white p-3 rounded-md">
                        ...
                        <ul class="text-gray-500 text-sm">
                            <p class="inline text-sm font-semibold ml-1">{{ $gedung_lap->gl_kapasitas_gedung }}</p>
                            <sup class="text-xs text-gray-500"> Orang </sup>
                        </ul>
                    </div>
                    <div class="bg-white p-3 rounded-md">
                        <h4 class="font-semibold mb-2">Harga</h4>
                        <p class="text-primary font-bold">Rp {{ number_format($gedung_lap->gl_tarif, 0, ',', '.') }}</p>
                        <p class="text-xs text-gray-400"> * belum termasuk voucher</p>
                        <a href="{{ route('gedung.pesan', $gedung_lap->gl_slug) }}"
                            class="block text-center text-sm mt-4 h-6 w-full bg-primary rounded-lg hover:opacity-50 text-white">Pesan</a>
                    </div>
                </div>
            </div>
