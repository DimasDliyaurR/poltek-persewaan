...
@section('content')
    <div class="pt-40">
        <div class="container px-20">
            ...
            <<<<<<< HEAD:resources/views/kategori/gedung.blade.php @if ($gedung_lap->count())
                                ...
                                <div class="py-8 px-6">
                                    <div id="default-carousel" class="relative w-full" data-carousel="slide">
                                        ...
                                        <div class="relative h-56 overflow-hidden rounded-md ">
                                            ...
                                            <!-- Item 4 -->
                                            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                                <img src="{{ asset('img/penginapan/truk_kanan.JPG') }}"
                                                    class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 shadow-lg rounded-md"
                                                    alt="gambar 4">
                                            </div>
                                        </div>
                                                            ...
                                                            <div class="bg-white  rounded-xl shadow-lg overflow-hidden ">
                                                                <div class="py-8 px-6">
                                                                    <div id="default-carousel" class="relative w-full"
                                                                        ...
                                                                        <!-- Carousel wrapper -->
                                                                        <div
                                                                            class="relative h-56 overflow-hidden rounded-md ">
                                                                            <!-- Item 1 -->
                                                                    ...
                                                                    <h3>
                                                                        <a href=" {{ route('detailgedung', $gl->id) }} "
                                                                            class="block mb-3 mt-3 font-semibold text-xl text-black hover:text-primary truncate">{{ $gl->gl_nama }}</a>
                                                                    </h3>
                                                                    <div class="flex mb-2">
                                                                        ...
                                                                        <p class="text-sm font-semibold ml-1">
                                                                            {{ $gl->gl_kapasitas_gedung }}</p>
                                                                        <sup class="text-xs text-gray-500"> Orang / kamar
                                                                        </sup>
                                                                    </div>
                                                                    <p
                                                                        class="text-xs text-gray-500 mb-1  flex justify-between">
                                                                        *check out 12.00 a.m <span
                                                                            class=" text-black font-bold text-base">Rp
                                                                            {{ $gl->gl_tarif }}</span></p>
                                                                    <p class=" text-sm text-gray-500 mb-1 float-right ">
                                                                        {{ $gl->gl_satuan_gedung }}</p>
                                                                    <button
                                                                        class=" h-8 w-full bg-primary rounded-lg hover:opacity-50"><a
                                                                            href="{{ route('pesan', $gl->id) }}"
                                                                            class=" text-sm   text-white    ">Sewa</a></button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                    >>>>>>> HOME-FE:resources/views/GedungLap/index.blade.php
                                        ...
                                        <p class="text-xs text-gray-500 mb-1  flex justify-between">*check out 12.00 a.m
                                            <span class=" text-black font-bold text-base">Rp {{ $gl->gl_tarif }}</span>
                                        </p>
                                        <p class=" text-sm text-gray-500 mb-1 float-right "> {{ $gl->gl_satuan_gedung }}
                                        </p>
                                        <button class=" h-8 w-full bg-primary rounded-lg hover:opacity-50"><a
                                                href="" class=" text-sm   text-white    ">Sewa</a></button>
                                    </div>
                                </div>
                            </div>
                    @endforeach
