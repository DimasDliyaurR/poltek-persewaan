...
@section('content')
    ...
    <div class="pt-4">
        <x-title-component>
            List Detail Foto Dari <span class="font-normal">{{ $layanan->l_nama }}</span>
        </x-title-component>
    </div>
