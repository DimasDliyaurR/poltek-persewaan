...
@section('content')
    ...
    <x-inner-layout>
        ...
        <form action="{{ route('detailFotoTipeAsrama.create', $tipeAsrama->id) }}" method="post"
            enctype="multipart/form-data">
            @csrf

            <div class="mb-5">
                <label for="dfta_foto" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Foto</label>
                <input name="dfta_foto"
    ...
    <div class="pt-4">
        <x-title-component>
            List Detail Foto Dari <span class="font-normal">{{ $tipeAsrama->ta_nama }}</span>
        </x-title-component>
    </div>
