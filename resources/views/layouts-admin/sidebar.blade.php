    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            @if (auth()->user()->level == 'admin' ||
                    auth()->user()->level == 'admin_keuangan' ||
                    auth()->user()->level == 'admin_dpupk')
                {{-- Laporan --}}
                <li>
                    <button type="button"
            ...
            @if (auth()->user()->level == 'admin_kendaraan' || auth()->user()->level == 'admin')
                <li>
                    {{-- Kendaraan --}}
                    <button type="button"
                        class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
            ...
            @endif
            @if (auth()->user()->level == 'admin_asrama' || auth()->user()->level == 'admin')
                {{-- Asrama --}}
                <li>
                    <button type="button"
                        class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
            ...
            @endif
            {{-- Alat Barang --}}
            @if (auth()->user()->level == 'admin_alat_barang' || auth()->user()->level == 'admin')
                <li>
                    <button type="button"
                        class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
            ...
            @endif
            {{-- Gedung & Lapangan --}}
            @if (auth()->user()->level == 'admin_gedung_lap' || auth()->user()->level == 'admin')
                <li>
                    <button type="button"
                        class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
            ...
            @endif
            {{-- Layanan --}}
            @if (auth()->user()->level == 'admin_layanan' || auth()->user()->level == 'admin')
                <li>
                    <button type="button"
                        class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
            ...
            @if (auth()->user()->level == 'admin')
                ...
                <li>
                    ...
                    <ul id="dropdown-example-user" class="{{ $action == 'user' ? '' : 'hidden' }} py-2 space-y-2">
                        ...
                        <li>
                            <a href="{{ route('admin.changePassword.index') }}"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Ubah
                                Password</a>
                        </li>
                        <li>
                            <a href="{{ asset('admin/activity-log') }}"
