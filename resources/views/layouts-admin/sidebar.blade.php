<aside id="sidebar-multi-level-sidebar"
    class="max-[640px]:fixed h-auto left-0 z-40 w-64 max-[640px]:h-screen transition-transform -translate-x-full sm:translate-x-0 border-b-2 border-solid border-blue-400"
    aria-label="Sidebar">
