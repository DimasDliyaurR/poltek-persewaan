                ...
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3">
                        <div class="flex items-center">
                            Tanggal Sewa
                            <button x-on:click="$wire.set('order', 'ta_tanggal_sewa')">
                                @if ($orderAction == 0 or $order != '' and $order != 'ta_tanggal_sewa')
                                    <svg class="w-3 h-3 ms-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        fill="currentColor" viewBox="0 0 24 24">
                                        <path
                                            d="M8.574 11.024h6.852a2.075 2.075 0 0 0 1.847-1.086 1.9 1.9 0 0 0-.11-1.986L13.736 2.9a2.122 2.122 0 0 0-3.472 0L6.837 7.952a1.9 1.9 0 0 0-.11 1.986 2.074 2.074 0 0 0 1.847 1.086Zm6.852 1.952H8.574a2.072 2.072 0 0 0-1.847 1.087 1.9 1.9 0 0 0 .11 1.985l3.426 5.05a2.123 2.123 0 0 0 3.472 0l3.427-5.05a1.9 1.9 0 0 0 .11-1.985 2.074 2.074 0 0 0-1.846-1.087Z" />
                    ...
                    <th scope="col" class="px-6 py-3">
                        <div class="flex items-center">
                            Check In
                            <button x-on:click="$wire.set('order', 'ta_check_in')">
                                @if ($orderAction == 0 or $order != '' and $order != 'ta_check_in')
                                    <svg class="w-3 h-3 ms-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        fill="currentColor" viewBox="0 0 24 24">
                                        <path
                                            d="M8.574 11.024h6.852a2.075 2.075 0 0 0 1.847-1.086 1.9 1.9 0 0 0-.11-1.986L13.736 2.9a2.122 2.122 0 0 0-3.472 0L6.837 7.952a1.9 1.9 0 0 0-.11 1.986 2.074 2.074 0 0 0 1.847 1.086Zm6.852 1.952H8.574a2.072 2.072 0 0 0-1.847 1.087 1.9 1.9 0 0 0 .11 1.985l3.426 5.05a2.123 2.123 0 0 0 3.472 0l3.427-5.05a1.9 1.9 0 0 0 .11-1.985 2.074 2.074 0 0 0-1.846-1.087Z" />
                    ...
                    <th scope="col" class="px-6 py-3">
                        <div class="flex items-center">
                            Check Out
                            <button x-on:click="$wire.set('order', 'ta_check_out')">
                                @if ($orderAction == 0 or $order != '' and $order != 'ta_check_out')
                                    <svg class="w-3 h-3 ms-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        fill="currentColor" viewBox="0 0 24 24">
                                        <path
                                            d="M8.574 11.024h6.852a2.075 2.075 0 0 0 1.847-1.086 1.9 1.9 0 0 0-.11-1.986L13.736 2.9a2.122 2.122 0 0 0-3.472 0L6.837 7.952a1.9 1.9 0 0 0-.11 1.986 2.074 2.074 0 0 0 1.847 1.086Zm6.852 1.952H8.574a2.072 2.072 0 0 0-1.847 1.087 1.9 1.9 0 0 0 .11 1.985l3.426 5.05a2.123 2.123 0 0 0 3.472 0l3.427-5.05a1.9 1.9 0 0 0 .11-1.985 2.074 2.074 0 0 0-1.846-1.087Z" />
                    ...
                    <th scope="col" class="px-6 py-3">
                        <div class="flex items-center">
                            Sub Total
                            <button x-on:click="$wire.set('order', 'ta_sub_total')">
                                @if ($orderAction == 0 or $order != '' and $order != 'ta_sub_total')
                                    <svg class="w-3 h-3 ms-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        fill="currentColor" viewBox="0 0 24 24">
                                        <path
                                            d="M8.574 11.024h6.852a2.075 2.075 0 0 0 1.847-1.086 1.9 1.9 0 0 0-.11-1.986L13.736 2.9a2.122 2.122 0 0 0-3.472 0L6.837 7.952a1.9 1.9 0 0 0-.11 1.986 2.074 2.074 0 0 0 1.847 1.086Zm6.852 1.952H8.574a2.072 2.072 0 0 0-1.847 1.087 1.9 1.9 0 0 0 .11 1.985l3.426 5.05a2.123 2.123 0 0 0 3.472 0l3.427-5.05a1.9 1.9 0 0 0 .11-1.985 2.074 2.074 0 0 0-1.846-1.087Z" />
                ...
                @forelse($transaksiAsrama as $row)
                    <tr id="parent" onclick="toggleTable(this)" class="cursor-pointer"
                        ...
                        <td class="px-6 py-4 text-right">
                            <a href="{{ route('laporan.asrama.show', $row->id) }}"
                        ...
                        <td colspan="8" class="px-[4.5rem] py-3 border-b-2 border-gray-200 bg-gray-50">
                            <div>
                                <ul class="flex gap-x-32">
                                    @foreach ($row->asramas as $asrama)
                                        <li>{{ $asrama->a_nama_ruangan }}</li>
                                        <li>{{ $asrama->tipeAsrama->ta_nama }}</li>
                                        <li>Rp.
                                            {{ number_format($asrama->tipeAsrama->ta_tarif, 0, ',', '.') }}
                                        </li>
                                        <li>Metode Pembayaran
                                            ({{ $asrama->tipeAsrama->paymentMethod->is_dp ? 'DP' : 'LUNAS' }})
                                        </li>
                                    @endforeach
                                </ul>
                                <ul class="mx-11  flex gap-x-32">
                                    @foreach ($row->fasilitasAsrama as $fasilitas)
                                        <li>{{ $fasilitas->fa_nama }}</li>
                                        <li>Rp. {{ number_format($fasilitas->fa_tarif, 0, ',', '.') }}</li>
                                    @endforeach
                                    <li></li>
                                </ul>
                            </div>
