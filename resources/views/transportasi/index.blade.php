...
@section('content')
    <div class="pt-2 pb-16 bg-slate-100 relative ">
        <div id="kat"
            class="  mb-16 mt-52 w-3/4 h-40 bg-white mx-auto rounded-lg shadow-lg text-center justify-center items-center  ">
            <div class="flex z-10">
                <div class="w-1/5 h-40 bg-primary text-white rounded-lg p-4 cursor-pointer active">
