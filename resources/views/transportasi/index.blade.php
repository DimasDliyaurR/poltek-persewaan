                        ...
                        <div class="bg-white  rounded-xl shadow-lg overflow-hidden ">
                            <div class="py-8 px-6">
                                ...
                                <div class="flex mb-2">
                                    ...
                                    <p class="text-sm font-semibold ml-2">{{ $item->mk_bahan_bakar }}</p>
                                ...
                                <a href="{{ route('transportasi.detail', $item->mk_slug) }}"
                                    class="block text-center mt-8 text-white h-8 w-full bg-primary rounded-lg hover:opacity-50">sewa
                                </a>
                            </div>
                        </div>
