            ...
            <div class="w-full px-4 lg:w-1/2 xl:w-1/3 mb-3">
                <div class="bg-white  rounded-xl shadow-lg overflow-hidden ">
                    <div class="py-8 px-6">
                        ...
                        <h3>
                        <a href="{{ route('detailkendaraan', $kendaraan->id) }}" class=" font-semibold text-xl text-black hover:text-primary truncate mb-1">{{$kendaraan->k_nama}}</a>
                        </h3>
                        <div class="flex mb-2"> 
                        ...
                        <p class="text-sm text-gray-500 mb-1  flex justify-between">Status <span class=" text-black font-bold text-base">Rp 2.500.000</span></p>
                        <p class=" text-sm text-gray-500 mb-1 float-right "> unit / Hari</p>
                        <button class=" h-8 w-full bg-primary rounded-lg hover:opacity-50"><a href="{{ route('k_pesan', $kendaraan->id) }}" class=" text-sm   text-white " >Sewa</a></button>
                    </div>
                </div>
            </div>
            @endforeach
