                ...
                <form action="" method="post">
                    ...
                    <div class="flex space-x-2 mb-2">
                        <div class="flex lg:flex-col mb-2 space-y-2  ">
                            ...
                            <input id="tk_tanggal_sewa" name="tk_tanggal_sewa" type="date" class="border-plaster">
                        </div>
                        <div class="flex lg:flex-col mb-2 space-y-2 rounded-md">
                            <label for="tk_tanggal_kembali">Tanggal Kembali</label>
                            <input id="tk_tanggal_kembali" name="tk_tanggal_kembali" type="date" class="border-plaster">
                        </div>
                    </div>
                    <hr class="">
                    <!--</div>-->
                    ...
                    <div class="relative py-2 ">
                        <button class="  h-7 w-32 bg-primary rounded-lg hover:opacity-50  absolute right-0 "> <a
                                href="">Tambah Item</a></button>
                    </div>
                    <div class=" flex py-6">
                        <img src="{{ asset('img/transportasi/bus.jpg') }}" alt="gambar item yang akan disewa"
                            class="xl:1/3 2xl:1/3 md:1/3 lg:w-1/3 w-full">

                        <div class=" py-36">
                            <!-- /content -->
                            <div
                                class="flex  mx-auto xl:flex-row md:flex-row lg:flex-row  flex-col justify-center  xl:space-x-2 p-3 ">
                                ...
                                <div class="basis-1/6 flex-col space-y-2">
                                    <div class="bg-white  relative  p-3  rounded-md  border-2">
                                        ...
                                        <div id="indicators-carousel" class="relative w-full" data-carousel="static">
                                            ...
                                            <div class="relative h-36 overflow-hidden rounded-lg ">
                                                ...
                                                <div class="hidden duration-700 ease-in-out" data-carousel-item="active">
                                                    <img src="{{ asset('img/transportasi/bus.jpg') }}"
                                                        class=" rounded-lg absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                                                        alt="...">
                                                </div>
                                                <!-- Item 2 -->
                                            ...
                                            <!-- Slider indicators -->
                                            <div
                                                class="absolute z-30 flex -translate-x-1/2 space-x-3 rtl:space-x-2 -bottom-3 left-1/2">
                                                <button type="button" class="w-2 h-2 rounded-full bg-gray-300"
                                            ...
                                            <button type="button"
                                                ...
                                                data-carousel-prev>
                                                <span
                                                    class="inline-flex items-center justify-center w-5 h-5 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
                                    ...
                                    <div class="bg-white p-3 rounded-md  border-2">
                                        ...
                                        <p class="text-xs text-gray-400 mb-2"> * untuk survey dan pertanyaan lainnya bisa
                                            menghubungi whatsapp berikut.</p>
