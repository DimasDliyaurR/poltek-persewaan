    ...
    <div class=" bg-plaster py-24 ">
        <div class=" container  ">
                ...
                <x-layout-detail-transaksi
                    ...
                    <div class="basis-3/5 h-auto flex flex-row gap-4 rounded-md p-4 mb-2 ml-2 ">
                        <div class="flex-col space-y-2 w-full">
                            <p class="font-bold text-4xl"> {{ $kendaraan->mk_merk }}</p>
                            <p class="text-primary font-bold text-2xl">Rp
                                {{ number_format($kendaraan->mk_tarif, 0, ',', '.') }}
                ...
                <form action="{{ route('transportasi.pesan.action') }}" method="POST" id="form_asrama">
                    ...
                    <div
                        ...
                        <div class=" mb-2 space-y-2  ">
                            <label for="tk_pelaksanaan"
                                class=" block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tanggal
                                Pelaksanaan</label>
                            <input id="tk_pelaksanaan" name="tk_pelaksanaan" type="date"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">

                            <p class="text-red-500 text-sm hidden" id="tk_pelaksanaan_error"></p>
                        </div>
                        <div class=" mb-2 space-y-2">
                            <label for="tk_durasi"
                                class=" block mb-2 text-sm font-medium text-gray-900 dark:text-white">Durasi</label>
                            <input id="tk_durasi" name="tk_durasi" type="text"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <p class="text-red-500 text-sm hidden" id="tk_durasi_error"></p>
                        </div>
                        <div class=" mb-2 space-y-2">
                            <label for="promo"
            ...
            <x-layout-detail-transaksi class="mt-5">
                <div class="mt-4 font">
                    <p class="text-base font-bold">Tentang {{ $kendaraan->mk_merk }}</p>
                    <div class="mt-5 mb-5">
...
@section('script')
    <script src="{{ asset('js/validasi/transportasi.js') }}"></script>
@endsection
