        ...
        <div class=" container  ">
            ...
            <div class="justify-start ml-36   mb-2 mt-2">
                <h2 class="text-base"> <a class="hover:text-primary hover:font-bold" href="/index#kategori">Kategori </a>
                    > {{ $title }}</h2>
                <h4 class="font-bold text-lg"> {{ $kendaraan->mk_merk }}</h4>
            </div>
            <!-- </div> -->
            {{-- Gambar Baru --}}
            ...
            <div class="flex xl:flex-row md:flex-row lg:flex-row flex-col justify-center space-x-2">
                <div class="flex justify-center">
                    <img src="{{ Storage::url($kendaraan->mk_foto) }}" class="w-full rounded-md shadow-lg h-60 object-cover"
                        alt="">
                </div>
                <div class="basis-3/5 h-auto flex flex-row gap-4 rounded-md p-4 mb-2 ml-2 ">
                    <div class="w-3/4 bg-white p-4 rounded-md">
                        ...
                        <div class="mt-4 font">
                            ...
                            <div class="list-disc mt-5 mb-5">
                                {!! $kendaraan->mk_deskripsi !!}
                            </div>
                    ...
                    <div class="w-1/4 flex-col space-y-2 ">
                        ...
                        <div class=" bg-white p-3 rounded-md">
                            ...
                            <p class="text-primary font-bold">Rp {{ number_format($kendaraan->mk_tarif, 0, ',', '.') }}</p>
                            {{-- <p class="text-xs text-gray-400"> * belum termasuk voucher</p> --}}<a href="{{ route('transportasi.pesan', $kendaraan->mk_slug) }}"
                                class="block text-center text-white text-sm mt-4 h-6 w-full bg-primary rounded-lg hover:opacity-50 text-white">Pesan</a>
                        </div>
                    </div>
                </div>
