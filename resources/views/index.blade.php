            ...
            <div class="bg-white  rounded-xl shadow-lg overflow-hidden ">
                <div class="py-8 px-6">
                    ...
                    <p><span class="icon-[material-symbols--person-add-rounded]" style="color: #FF7417;"></span>
                        <iconify-icon icon="material-symbols:person-add-rounded" style="color: #FF7417"></iconify-icon>
                    </p>
                            ...
                            <div class="flex flex-row"><a href="#"
                                    ...
                                    <div class="flex space-x-2">
                                        ...
                                        <div class="basis-1/2 relative">
                                            <div
                                                class="absolute right-0 top-2 text-center h-6 w-32 rounded-s-lg bg-primary overflow-hidden">
                    ...
                    <li>
                        <div class="hover:scale-105 transition  ease-in-out delay-150  ">
                            <div class="flex flex-row"><a href="#"
                                    ...
                                    <div class="flex space-x-2">
                                        <div class="basis-1/2">
                                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Promo Ketupat
                                            </h5>
                                            <div class="flex  items-center">
                                                <h4 class="text-base mr-2">Hemat</h4>
                                                <span class="text-4xl font-bold">50%</span>
                    ...
                    <li>
                        <div class="  hover:scale-105 transition  ease-in-out delay-150  ">
                            <div class="flex flex-row"><a href="#"
                                    ...
                                    <div class="flex space-x-2">
                                        <div class="basis-1/2">
                                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Promo Nataru
                                            </h5>
                                            <div class="flex  items-center">
                                                <h4 class="text-base mr-2">Hemat</h4>
                                                <span class="text-4xl font-bold">50%</span>
                        ...
                        <div class=" container xl:w-10/12  ">
                            ...
                            <div class="flex">
                                <div class="w-1/12 flex items-center">
                                    <div class="w-full text-right">
                                        <button onclick="prev()"
                                            class="p-3 rounded-full bg-white border border-gray-100 shadow-lg">
                                                ...
                                                <div class="flex flex-row"><a href="#"
                                                        ...
                                                        <div class="flex space-x-2">
                                                            ...
                                                            <div class="basis-1/2 relative">
                                                                ...
                                                                <img src="{{ asset('img/layanan/marching band.jpg') }}"
                                                                    alt="picture 1" class=" rounded-md w-full " />
                                                            </div>
                                                        </div>
                                                        <p class="text-gray-400 text-sm ">*periode 1 Januari - 1 Februari
                                                        </p>
                                                    </a>
                                                </div>
                                            </div>
                                ...
                                <div class="flex items-center pb-4 pt-2">
                                    ...
                                    <div class="ml-3">
                                        ...
                                        <p class="text-justify ">Dengan melakukan pemesanan gedung maka anda tidak usah
                                            bingung untuk menyewa tempat penyewaan kursi, kamera , dll.</p>
                                    </div>
                                </div>
                            </div>
            </section>
            ...
            <div class=" ">
                <a href="#home" class="">
                    <i class=" btnbtt btn-active fixed bottom-6 right-6 text-5xl cursor pointer text-primary hover:bg-gray-100 z-20 hidden bg-softblue rounded-full w-12 h-12 "
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke-width="1.5" stroke="currentColor" class="w-7 h-7 mt-2 ml-2">
