      ...
      <h1 class="block font-bold  xl:text-5xl lg:text-4xl pt-10 pb-2">SEWA ASET </h1>
        ...
        <div id="buttondropdown" class="mx-auto flex justify-center">
          ...
          <div id="dropdownJadwal" class="relative">
            ...
            <div id="dropdownKal" class="rounded border-[2px] border-white bg-white p-2 absolute top-[50px] w-[180px]  shadow-md hidden">
              <div class="cursor-pointer hover:bg-gray-300 p-1 rounded text-sm text-left">
                <a href="/transportasi/kalender"><p>Kalender Transportasi</p></a>
              </div>
              <div class="cursor-pointer hover:bg-gray-300 p-1 rounded text-sm text-left" >
    ...
    <div id="kat" class=" relative bg-white rounded-lg flex  flex-wrap xl:w-3/5 mx-auto xl:shadow-lg  -mt-20">
      <div class="xl:w-1/5 md:w-1/3 w-1/2 shadow-lg xl:shadow-none  h-40 hover:bg-gray-300 rounded-lg p-4 cursor-pointer flex justify-center items-center ">
        ...
        <svg version="1.1" class="hover:text-white  mt-6 h-16 w-16 mx-auto" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100%" viewBox="0 0 500 500" enable-background="new 0 0 500 500" xml:space="preserve">
          ...
          z"/>
          <path fill="#F87821" class="hover:fill-white" opacity="1.000000" stroke="none" 
            d="
          ...
          z"/>
          <path fill="#F57B29" class="hover:fill-white" opacity="1.000000" stroke="none" 
            d="
          ...
          z"/>
          <path fill="#F47A28" class="hover:fill-white" opacity="1.000000" stroke="none" 
            d="
          ...
          z"/>
          <path fill="#FEB47F" class="hover:fill-white"s opacity="1.000000" stroke="none" 
            d="
          ...
          <path fill="#FAC39E" class="hover:fill-white" opacity="1.000000" stroke="none" 
            d="
          ...
          z"/>
          <path fill="#FD751A" class="hover:fill-white" opacity="1.000000" stroke="none" 
            d="
          ...
          z"/>
          <path fill="#F9771F" class="hover:fill-white" opacity="1.000000" stroke="none" 
            d="
      ...
      <div class="xl:w-1/5 w-1/2  md:w-1/3 shadow-lg xl:shadow-none h-40 hover:bg-gray-300 rounded-lg p-4 cursor-pointer flex justify-center items-center">
        ...
        <div class="xl:w-1/5 w-1/2  md:w-1/3 shadow-lg xl:shadow-none  h-40 hover:bg-gray-300 rounded-lg p-4 cursor-pointer sm:mx-auto mx-auto xs:mx-auto flex justify-center items-center">
          ...
          <img src="{{ asset('img/kategori/asset.png') }}" alt="" class=" mt-6 hover:filter hover:invert h-22 w-20 mx-auto">
          </a>
        </div>
    </div>
    <!-- kategori section -->
    ...
    <div class="container w-full xl:w-10/12">
      <div class="flex flex-wrap justify-center items-center mx-auto xl:space-x-2 space-y-2 "> 
        ...
        <svg version="1.1" class="hover:text-white  mt-6 h-16 w-16 mx-auto" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100%" viewBox="0 0 500 500" enable-background="new 0 0 500 500" xml:space="preserve">
          ...
          <p class="mb-3 font-normal text-gray-500 ">Aset pada kategori transportasi kami memiliki sebanyak 8 buah transportasi.</p>
        ...
        <div class="xl:w-1/6 bg-white border-2 border-gray-100 shadow-md h-80 p-2 items-center text-center">
          <img src="{{ asset('img/kategori/asset.png') }}" alt="" class=" mt-6 hover:filter hover:invert h-16 w-16 mx-auto">
  ...
  <div class="container">
      <div class="w-full  px-4 ">
        <div class=" mx-auto text-center mb-12">
          ...
          <p class="font-medium text-base md:text-lg">Penawaran promo sangat beragam. Lakukan penyewaan sekarang juga dan dapatkan promo menarik lainnya !</p>
        </div>
      </div>

    <div class=" container xl:w-10/12  ">
      <div class="flex flex-wrap xl:px-24 pb-2 kategori-promo  xl:space-x-2  mx-auto text-[14px] ">
        <div class="bg-white w-1/4  h-8 xl:w-28 flex items-center justify-center rounded-md mb-2 space-kanan cursor-pointer hover:focus:ring-primary hover:border-primary hover:border-2  "><a href="/promo" class="overflow-hidden">Semua</a>  </div>
        ...
        <div class="pb-4 pt-4">
          ...
          <div id="accordion-color-body-1" class="hidden" aria-labelledby="accordion-color-heading-1">
            <div class="p-5 border border-t-0 border-grecianblue  dark:bg-gray-900">
              <p class="mb-2 text-gray-500 dark:text-gray-400">Pembayaran tarif persewaaan sesuai dengan website dan tidak ada biaya tambahan lainnya.</p>
        ...
        <div class="pb-4 pt-4">
          ...
          <div id="accordion-color-body-3" class="hidden" aria-labelledby="accordion-color-heading-3">
            <div class="p-5 border border-t-0 border-gray-200 ">
              <p class="mb-2 text-gray-500 dark:text-gray-400">Tarif yang telah telah dibayarkan, tidak dapat dikembalikan.</p>
              <!-- <p class="mb-2 text-gray-500 dark:text-gray-400">However, we actually recommend using both Flowbite, Flowbite Pro, and even Tailwind UI as there is no technical reason stopping you from using the best of two worlds.</p> -->
              <!-- <p class="mb-2 text-gray-500 dark:text-gray-400">Learn more about these technologies:</p> -->
              <ul class="ps-5 text-gray-500 list-disc dark:text-gray-400">
                <li><a href="https://flowbite.com/pro/" class="text-blue-600 dark:text-blue-500 hover:underline">Pembatalan dari penyewa</a></li>
...
<!-- back to top -->
  <div class=" ">
    <a href="#home" class=""> 
      ...
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7 mt-2 ml-2">
...
<!-- end back to top -->
    ...
    <div class="relative">
      ...
      <a aria-label="Chat on WhatsApp" href="https://wa.me/6282332829821/?text=Halo, Admin Saya Ingin bertanya terkait sewa aset poltekbang surabaya" class="mx-auto mt-1 ">
