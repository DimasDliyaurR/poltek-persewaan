...
<div class="container relative z-10 pb-56 flex flex-wrap mt-32">
    <div class="w-full text-center px-4 ">
      <h1 class="block font-bold  text-9xl lg:text-4xl pt-10 pb-2">SEWA ASET </h1>
...
<!-- back to top -->
  <div class=" ">
      ...
      ><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7 mt-1 ml-2">
...
<!-- end back to top -->
    <!-- call -->
    <div class="relative">
      <div class=" cursor-pointer w-10 h-10 border rounded-full bg-softblue  flex fixed  right-20 bottom-6 bocursor-pointer hover:w-30 hover:h-10 hover:Hubungi Kami !" title="Chat sekarang ! "> 
      <a aria-label="Chat on WhatsApp" href="https://wa.me/6289529811097/?text=Hello Saya Ingin bertanya" class="mx-auto mt-1 ">
