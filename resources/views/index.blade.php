...
@section('content')
                ...
                <div id="buttondropdown" class="mx-auto flex">
                  ...
                  <h1 class="block font-bold text-slate-900 text-4xl lg:text-5xl pt-10 pb-2">SEWA ASET </h1>
                    <h2 class="font-semibold md:text-xl lg:text-2xl mt-6 leading relaxed mb-8 ">Mudah, Aman , Terjangkau !</h2>
                        ...
                        <div class="w-full  self-center px-10  xl:w-1/2 lg:w-1/2 ">
                            <h1 class="text-base text-grecianblue font-semibold  md:text-xl lg:text-2xl">Ayoo <span
                                    class="text-black block font-bold text-slate-900 text-4xl lg:text-5xl pb-2">SEWA ASET
                                </span></h1>
                            <h2
                                class="flex justify-center xl:justify-start font-semibold md:text-xl lg:text-2xl mt-6 leading relaxed mb-8  ">
                                Mudah, Aman , Terjangkau !</h2>
                            <div id="buttondropdown" class="mx-auto flex">
                                ...
                                <div id="dropdownJadwal" class="relative">
                                    <div onclick="toggleDropdown2()"
                                        ...
                                        <svg class=" pl-2 w-5 " xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        <div class="container w-full xl:w-1/2 self-end ">
                            <img src="{{ asset('img/landingpage/lp.png') }}" alt="Logo Poltekbang"
                                class="w-3xl h-full mx-auto" />
                        </div>
                    </div>
    </section>
    <!-- Hero Section End -->
    ...
    <<<<<<< HEAD <section id="promo" class="pt-36 pb-36 bg-plaster">
        <div class="container">
            ...
            <div class=" container xl:w-10/12  ">
                <div class="flex flex-wrap  pb-2 kategori-promo  xl:space-x-2   text-[14px] ">
                    <div
                        ...
                        <a href="" class="overflow-hidden">Semua</a>
                    </div>
                    <div
                        class="bg-white  w-1/4  h-8 xl:w-28 flex items-center justify-center rounded-md mb-2 space-kanan  cursor-pointer hover:focus:ring-primary hover:border-primary hover:border-2  ">
                        <a href="" class="overflow-hidden">Transportasi</a>
                    </div>
                    <div
                        ...
                        <a href="" class="overflow-hidden">GedungLap</a>
                    </div>
                    <div
                        class="bg-white w-1/4  xl:w-28 h-8 flex items-center justify-center rounded-md mb-2 space-kanan cursor-pointer  hover:focus:ring-primary hover:border-primary hover:border-2  ">
                        <a href="" class="overflow-hidden">Asrama</a>
                    </div>
                    <div
                        class="bg-white w-1/4  xl:w-28 h-8 flex items-center justify-center rounded-md mb-2 space-kanan cursor-pointer  hover:focus:ring-primary hover:border-primary hover:border-2  ">
                        <a href="" class="overflow-hidden">Layanan</a>
                    </div>
                    <div
                        class="bg-white w-1/4  xl:w-28 h-8  flex items-center justify-center  rounded-md mb-2 space-kanan cursor-pointer  hover:focus:ring-primary hover:border-primary hover:border-2 ">
                        <a href="" class="overflow-hidden">Alat Barang</a>
                    </div>
                </div>
                    ...
                    <div id="accordion-color" data-accordion="collapse"
                        ...
                        <div class="pb-4 pt-4">
                            ...
                            <div id="accordion-color-body-1" class="hidden" aria-labelledby="accordion-color-heading-1">
                                <div class="p-5 border border-t-0 border-grecianblue ">
                                    <p class="mb-2 text-gray-500 ">Tarif persewaan tidak ada tambahan lain. Biaya
                                        administrasi
                                        pelayanan di sewa aset poltekbang gratis.</p>
                                    <p class="text-gray-500 "> Keterlambatan dan kerusakan barang dikenakan denda sampai
                                        dengan
                                        <a href="/docs/getting-started/introduction/"
                                            class="text-blue-600  hover:underline">30%</a>.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pb-4 pt-4">
                            ...
                            <div id="accordion-color-body-5" class="hidden" aria-labelledby="accordion-color-heading-4">
                                <div class="p-5 border border-t-0 border-grecianblue">
                                    <p class="mb-2 text-gray-500 ">1. Memiliki akun / mendaftar terlebih dahulu di sistem
                                        SEWA
                                        ASET.</p>
                                    <p class="mb-2 text-gray-500 ">2. Berkas yang harus disiapkan ketika mendaftar:</p>
                                    <ul class="ps-5 text-gray-500 list-disc ">
                                        <li><a href="https://flowbite.com/pro/"
                                                class="text-blue-600  hover:underline">Foto
                                                KTP</a></li>
                                        <li><a href="https://tailwindui.com/" rel="nofollow"
                        ...
                        <div id="accordion-color" data-accordion="collapse"
                            ...
                            <div class="pb-4 pt-4">
                                ...
                                <div id="accordion-color-body-1" class="hidden"
                                    ...
                                    <div
                                        ...
                                        <p class="mb-2 text-gray-500 dark:text-gray-400">Tarif persewaan tidak ada
                                            tambahan
                                            lain.
                                ...
                                <h2 id="accordion-color-heading-2">
                                    <button type="button"
                                        ...
                                        <div class="flex items-center gap-2">
                                            <img width="23" height="23" class="p-0"
                                                src="https://img.icons8.com/ios/50/help--v2.png" alt="help--v2" />
                                            <span>Bagaimana saya melakukan sewa transportasi dari lokasi yang
                                                berbeda?</span>
                                        </div>
                                        <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0 max-w-none max-h-none"
                                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                                ...
                                <div id="accordion-color-body-2" class="hidden"
                                    ...
                                    <div class="p-5 border border-t-0 border-grecianblue dark:border-gray-700">
                                        <p class="mb-2 text-gray-500 dark:text-gray-400">Sewa transportasi di kami, <span
                                                class="font-bold">gratis</span> antar jemput dengan sopir yang
                                            profesional.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="pb-4 pt-4">
                                ...
                                <div id="accordion-color-body-5" class="hidden"
                                    aria-labelledby="accordion-color-heading-4">
                                    <div class="p-5 border border-t-0 border-grecianblue">
                                        <p class="mb-2 text-gray-500 dark:text-gray-400">1. Memiliki akun / mendaftar
                                            terlebih
                                            dahulu di sistem SEWA ASET.</p>
                                        <p class="mb-2 text-gray-500 dark:text-gray-400">2. Berkas yang harus disiapkan
                                            ketika
                                            mendaftar:</p>
                                        <ul class="ps-5 text-gray-500 list-disc dark:text-gray-400">
                                            <li><a href="https://flowbite.com/pro/"
                                                    class="text-blue-600 dark:text-blue-500 hover:underline">Foto KTP</a>
                                            </li>
                                            <li><a href="https://tailwindui.com/" rel="nofollow"
                            ...
                            <div class="container">
                                <div class=" w-full px-4">
                                    <div class="mx-auto text-right xl:mr-20 mb-20">
                                        <h4 class="font-bold text-xl  uppercase text-primary ">Mengapa harus sewa di
                                            sewaaset
                                            poltkebang surabaya?</h4>
                                    </div>
                                    <div class="flex flex-wrap px-6">
                                        <div
                                            class="w-full  place-items-center h-full  md:w-1/2 lg:w-1/2 sm:justify-center ">
                                        ...
                                        <div class="w-full px-4 mb-10 md:w-1/2 lg:w-1/2">
                                            <div class="flex items-center pb-4 pt-2">
                                                <img src="{{ asset('img/landingpage/1.png') }}" alt="Waktu"
                                                    class="h-10 w-10">
                                                <div class="ml-3">
                                                    <p class=" font-bold  ">Semua keperluan dalam acara bisa sewa satu
                                                        tempat
                                                    </p>
                                                    <p class="text-justify ">Dengan melakukan pemesanan gedung maka anda
                                                        tidak
                                    ...
                                    <div class="w-full px-4">
                                        <div class="mx-auto text-center mb-16">
                                            ...
                                            <p class="font-medium text-medium md:text-lg">Jika terdapat pertanyaan, aduan,
                                                atau hal yang harus
                                                dikonfirmasi terlebih dahulu. Anda bisa langsung menghubungi kontak berikut
                                                ini
                                                .</p>
                                        </div>
                                    </div>
