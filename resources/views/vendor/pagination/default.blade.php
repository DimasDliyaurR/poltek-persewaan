                ...
                <span class="relative z-0 inline-flex mt-2 shadow-sm lg:mt-0">
                    ...
                    @else
                        ...
                        <a href="{{ $paginator->previousPageUrl() }}" rel="prev"
                            class="relative inline-flex items-center px-2 py-2 text-sm font-medium leading-5 transition bg-white border border-gray-300 rounded-l hover:text-gray-400 focus:z-10 focus:outline-none focus:border-primary-300 focus:ring focus:ring-primary-300 focus:ring-opacity-30 dark:focus:ring-primary-500 dark:focus:ring-opacity-30 dark:border-white dark:bg-gray-600 dark:text-gray-700 dark:border-secondary-600 dark:bg-secondary-700"
                    ...
                    @foreach ($elements as $element)
                        ...
                        @if (is_string($element))
                            <span aria-disabled="true">
                                <span
                                    class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium leading-5 text-gray-400 bg-white border border-gray-300 cursor-default dark:text-white dark:border-secondary-600 dark:bg-gray-600">{{ $element }}</span>
                            </span>
                        @endif
