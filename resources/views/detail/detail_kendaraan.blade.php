    ...
    <div class="  bg-plaster">
        <div class="container mx-auto px-4 py-24">
            ...
            <div class="  grid grid-cols-1 sm:grid-cols-2  lg:grid-cols-3 xl:gap-6 gap-6 md:gap-10 mx-auto">
                <div class="bg-white col-span-2  shadow-md p-4 w-full h-screen xl:ml-24  mx-auto rounded-md ">
                    <div class="relative -mr-24  ">
                        ...
                        <div class="mainImageContainer">
                            <img id="mainImage" src="{{ asset('img/layanan/marching band.jpg') }}" alt=""
                                width=""
                                class="rounded-sm cursor-pointer shadow-md overflow-hidden xl:w-8/12 w-6/12 lg:w-7/12 mb-4" />
                        </div>
                        <div class="container flex  gap-2 ">
                            <img src="{{ asset('img/transportasi/bus_depan.jpg') }}" alt="Nature"
                                class="rounded-sm  cursor-pointer shadow-md overflow-hidden sm:w-1/2 h-auto object-cover object-center  mb-4"
                                onclick="myFunction(this);">
                            <img src="{{ asset('img/transportasi/bus_kanan.jpg') }}" alt="Snow"
                                class="rounded-sm  cursor-pointer shadow-md overflow-hidden sm:w-1/2 h-auto object-cover object-center mb-4"
                                onclick="myFunction(this);">
                            <img src="{{ asset('img/transportasi/bus_kiri.jpg') }}" alt="Mountains"
                                class="rounded-sm  cursor-pointer shadow-md overflow-hidden sm:w-1/2 h-auto object-cover object-center mb-4"
                                onclick="myFunction(this);">
                            <img src="{{ asset('img/transportasi/bus.jpg') }}" alt="Lights"
                                class="rounded-sm  cursor-pointer shadow-md overflow-hidden sm:w-1/2 h-auto object-cover object-center mb-4"
                                onclick="myFunction(this);">
                        </div>
                        <div class="absolute top-0 xl:right-12 md:right-16 right-14   mt-1  overflow-hidden">
                            ...
                            <div class="flex mb-2 mt-2">
                                ...
                                <p class="xl:text-sm text-xs ml-1">Bagasi luas</p>
                            </div>
                            <div class="flex mb-2 mt-2">
                                <svg class="w-6 h-6 text-primary" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <p class="xl:text-sm text-xs ml-1">Free WiFi</p>
                            </div>
                            <div class="flex mb-2 mt-2">
                                <svg class="w-6 h-6 text-primary" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <p class="xl:text-sm text-xs ml-1">AC</p>
                            </div>
                            <div class="flex mb-2 mt-2">
                                <svg class="w-6 h-6 text-primary" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <p class="xl:text-sm text-xs ml-1">Full Audio</p>
                            </div>
                            <div class="flex mb-2 mt-2">
                                <svg class="w-6 h-6 text-primary" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <p class="xl:text-sm text-xs ml-1">TV LCD</p>
                            </div>
                            <!-- basic service -->
                            <h4 class=" text-base font-semibold ">Basic Service Include</h4>
                            <div class="flex mb-2 mt-2">
                                <svg class="w-6 h-6 text-primary" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                    <path fill-rule="evenodd"
                                ...
                                <p class="xl:text-sm text-xs ml-1">Sopir</p>
                            </div>
                            <div class="flex mb-2 mt-2">
                                <svg class="w-6 h-6 text-primary" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <p class=" xl:text-sm text-xs ml-1">Gratis antar jemput</p>
                            </div>
                            <!-- not basic service -->
                            <h4 class=" text-base font-semibold ">Biaya tidak Terhitung</h4>
                            <div class="flex mb-2 mt-2">
                                <svg class="w-6 h-6 text-primary" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                    <path fill-rule="evenodd"
                                ...
                                <p class="xl:text-sm text-xs ml-1">Bensin</p>
                            </div>
                            <div class="flex mb-2 mt-2">
                                <svg class="w-6 h-6 text-primary" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <p class=" xl:text-sm text-xs ml-1">Biaya parkir dan tol</p>
                            </div>
                            <!-- Ketentuan -->
                            <h4 class=" text-base font-semibold ">Ketentuan Persewaan</h4>
                            <div class="flex mb-2 mt-2">
                                <svg class="w-6 h-6 text-primary" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                    <path fill-rule="evenodd"
                                ...
                                <p class="xl:text-sm text-xs ml-1">Pembayaran DP 30%</p>
                            </div>
                            <div class="flex mb-2 mt-2">
                                <svg class="w-6 h-6 text-primary" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <p class=" xl:text-sm text-xs ml-1">Keterlambatan </p>
                            </div>
                            <!-- Refund -->
                            <h4 class=" text-base font-semibold ">Refund & Reschedule</h4>
                            <div class="flex mb-2 mt-2">
                                <svg class="w-6 h-6 text-primary" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                    <path fill-rule="evenodd"
                                ...
                                <p class="xl:text-sm text-xs ml-1">Bisa refund</p>
                            </div>
                            <div class="flex mb-2 mt-2">
                                <svg class="w-6 h-6 text-primary" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <p class=" xl:text-sm text-xs ml-1">Tidak bisa reschedule </p>
                            </div>
                            <div class="flex mb-2 mt-2">
                                <svg class="w-6 h-6 text-primary" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mt-4 font">
                            ...
                            <p class="text-sm text-gray-400 p-2 overflow-hidden">Info lebih lanjut hubungi kontak WhatsApp
                                di bawah ini : </p>
                ...
                <!-- sidebar -->
                <div class=" grid md:grid-rows-2 md:grid-flow-col  xl:gap-0 gap-8 xl:w-56 p-4 ml-24  md:gap-52 w-full  ">
                    <div class="bg-white h-36 w-64 relative -mt-4 p-3  rounded-md ">
