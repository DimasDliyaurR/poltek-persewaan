                ...
                <div class="px-4 flex items-center">
                    ...
                    <div class="ml-1">
                        <a href="/index #home" class="font-bold text-lg text-black">
                            SEWA ASET<br>
                            <span class="font-bold md:text-lg text-black text-sm">POLITEKNIK PENERBANGAN SURABAYA</span>
                        </a>
                    </div>
                    ...
                    <nav id="nav-menu"
                        ...
                        <ul class="block lg:flex">
                            ...
                            <div class="flex-flex wrap   ">
                                <a href="/pesan"
                                    class="text-base font-normal text-black py-2 mx-8 flex hover:text-primary"><span
                                        class="w-6 h-6"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                            <path fill="black"
                            ...
                            <li class="group">
                                <a href="/bayar"
                                    class="text-base text-black py-2 mx-8 flex group-hover:text-primary active:bg-primary"><span
                                        class="w-6 h-6"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                            <path fill="black"
                                        ...
                                        </svg></span>Pembayaran</a>
                            </li>
                            <li class="group">
                                <a href="/invoice"
                                    class="text-base text-black py-2 mx-8 flex group-hover:text-primary"><span
                                        class="w-6 h-6"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                            <path fill="black"
