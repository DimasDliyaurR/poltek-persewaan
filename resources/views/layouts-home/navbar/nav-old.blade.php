        ...
        <div class="container ">
            <div class="flex items-center justify-between relative">
                <div class=" flex items-center xl:px-8 py-2">
                    ...
                    <div id="judul-nav" class="ml-1 text-white">
                        <a href="/" class="font-bold xl:text-lg md:text-lg">
                            SEWA ASET<br>
                            <span class="font-bold xl:text-lg md:text-lg text-xs">POLITEKNIK PENERBANGAN
                                SURABAYA</span>
                        </a>
                    </div>
                </div>
                <div class="flex items-center px-8">
                    ...
                    <nav id="nav-menu"
                        ...
                        <ul class="block lg:flex text-white">
                            <li class="group"></li>
                            <a href="#home"
                                class="text-base font-normal py-2 mx-6 flex group-hover:text-primary">Beranda</a>
                            <li class="group">
                                <a href="#kategori"
                                    class="text-base py-2 mx-6 flex group-hover:text-primary">Kategori</a>
                            </li>
                            <li class="group">
