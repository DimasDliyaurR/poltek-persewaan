                ...
                <div class="flex items-center px-4">
                    ...
                    <nav id="nav-menu"
                        ...
                        <ul class="block lg:flex">
                            <li class="group"></li>
                            <a href="#home"
                                class="text-base font-normal text-black py-2 mx-8 flex group-hover:text-primary">Beranda</a>
                            <li class="group">
                                <a href="#kategori"
                                    class="text-base text-black py-2 mx-8 flex group-hover:text-primary">Kategori</a>
                            </li>
                            <li class="group">
                                <a href="#promo"
                                    class="text-base text-black py-2 mx-8 flex group-hover:text-primary">Promo</a>
                            </li>
                            <!-- <li class="group">
                  <a href="#FAQ" class="text-base text-black py-2 mx-8 flex group-hover:text-primary">FAQ</a>
                            ...
                            <li class="group">
                                <a href="#syarat"
                                    class="text-base text-black py-2 mx-8 flex group-hover:text-primary">Syarat</a>
                            </li>
                            <li class="group">
                                <a href="#FAQ"
                                    class="text-base text-black py-2 mx-8 flex group-hover:text-primary">Pesanan</a>
                            </li>
                            ...
                            @guest
                                @if (Route::has('login'))
                                    <li class="group">
                                        <a href="{{ route('login') }}"
                                            class="text-base text-black py-2 mx-8 flex group-hover:text-primary">{{ __('Login') }}</a>
                                    </li>
                                @endif

                                @if (Route::has('register'))
                                    <li class="group">
                                        <a class="text-base text-black py-2 mx-8 flex group-hover:text-primary"
            ...
            <div class="grid md:grid-cols-12 grid-cols-1 gap-7 pb-16">
                <div class="lg:col-span-5 col-span-12 ">
                    ...
                    <div class="mt-6 flex px-16">
                        <a href="https://youtube/poltekbang" target="_blank"
                            class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-gray-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white">
                ...
                <div class="lg:col-span-2 md:col-span-4 col-span-12">
                    ...
                    <ul class="list-none mt-6 space-y-2">
                        ...
                        <li>
                            <a href="#" class="inline-block text-base text-black hover:text-primary mb-3">Web
                                Utama</a>
                        </li>
                    </ul>
                </div>
