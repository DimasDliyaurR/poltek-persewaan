...
<header class="bg-transparent absolute top-0 left-0 w-full flex items-center z-10">
  ...
  <div class="xl:p-36 p-10  xl:w-2/3 lg:w-2/3 md:w-2/3  mx-auto ">
    <div class="container">
      <h4 class="font-bold uppercase 2xl:text-2xl md:text-2xl sm:text-2xl xl:text-2xl text-xl -mt-2">{{ $title }}</h4>
        <div class="row">
    ...
    @yield('script')
    <!-- footer New -->
    <footer class="bg-plaster 2xl:p-16 xl:p-16 lg:p-16 md:p-16 p-6 bottom-0">
