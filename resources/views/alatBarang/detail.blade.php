        ...
        <div class=" container  ">
            ...
            <div class="flex xl:flex-row md:flex-row lg:flex-row flex-col justify-center space-x-2">
                ...
                <x-layout-detail-transaksi
                    ...
                    {{-- <img src="{{ Storage::url($alatBarangs->l_foto) }}"
                        class="rounded-md shadow-lg w-[40rem] h-80 object-cover" alt=""> --}}

                    <x-multiple-image>
                        <x-sub-multiple-image src="{{ $alatBarangs->ab_foto }}" />
                        @foreach ($alatBarangs->fotoAlatBarangs as $image)
                            <x-sub-multiple-image src="{{ $image->fab_foto }}" />
                        @endforeach
                    </x-multiple-image>
                    ...
                    <div class="basis-3/5 h-full flex flex-col justify-between gap-4 rounded-md p-4 mb-2 ml-2 ">
                        <div class="flex-col space-y-2 w-full">
                            ...
                            <div class=" bg-white p-3 rounded-md">
                                <ul class="text-gray-500 text-sm ">
                                    <div class="flex mb-2">
                                        <p class="text-sm font-semibold ml-2">{{ $alatBarangs->ab_ukuran_gedung }}</p>
                                        <sup class="text-xs text-gray-500"></sup>
                                    </div>
                                    <div class="flex mb-2">
                                        <p class="text-sm font-semibold ml-1">{{ $alatBarangs->ab_kapasitas_gedung }}</p>
                                        <p class="text-xs text-gray-500 ml-1"></sup>
                                    </div>
            ...
            <x-layout-detail-transaksi class="mt-5 hidden" :isId="true" id="dropdown">
                ...
                <form action="{{ route('alat-barang.pesan.action') }}" method="POST" id="form_asrama">
                    ...
                    <div
                        ...
                        <div class=" mb-2 space-y-2  ">
                            <label for="tab_tanggal_pesanan"
                                ...
                                Pesanan</label>
                            <input id="tab_tanggal_pesanan" name="tab_tanggal_pesanan" type="date"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">

                            <p class="text-red-500 text-sm hidden" id="tab_tanggal_pesanan_error"></p>
                        </div>
                        <div class=" mb-2 space-y-2">
                            <label for="tab_tanggal_kembali"
                                class=" block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tanggal
                                Kembali</label>
                            <input id="tab_tanggal_kembali" name="tab_tanggal_kembali" type="date"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <p class="text-red-500 text-sm hidden" id="tab_tanggal_kembali_error"></p>
                        </div>
                        <div class=" mb-2 space-y-2">
                            <label for="promo"
                    ...
                    <div class=" mb-2 space-y-2">
                        <label for="tab_qty" class=" block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jumlah
                            Barang</label>
                        <input id="tab_qty" name="tab_qty" type="text"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <p class="text-red-500 text-sm hidden" id="tab_qty_error"></p>
                    </div>
                    <div class=" mb-2 space-y-2">
                        <label for="tab_keterangan"
                            class=" block mb-2 text-sm font-medium text-gray-900 dark:text-white">Keterangan</label>
                        <input id="tab_keterangan" name="tab_keterangan" type="text"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <p class="text-red-500 text-sm hidden" id="tab_keterangan_error"></p>
                    </div>
            ...
            <x-layout-detail-transaksi class="mt-5">
                <div class="mt-4 font">
                    <p class="text-base font-bold">Tentang {{ $alatBarangs->ab_nama }}</p>
                    <div class="mt-5 mb-5">
                        {!! $alatBarangs->ab_keterangan !!}
                    </div>
