            ...
            <div class="w-full px-4 lg:w-1/2 xl:w-1/3 mb-5">
                <div class="bg-white  rounded-xl shadow-lg overflow-hidden ">
                    <div class="py-8 px-6">
                        ...
                        <h3>
                        <a href=" " class="block mb-3 mt-3 font-semibold text-xl text-black hover:text-primary truncate">Nama Alat Barang</a>
                        </h3>
                        <div class="flex mb-2"> 
                        ...
                        <p class=" text-sm text-gray-500 mb-1 float-right "> Satuan persewaan</p>
