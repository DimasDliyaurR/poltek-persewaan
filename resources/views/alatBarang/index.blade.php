        ...
        <div class="container">
            <div class="w-full">
                <div class="max-w-xl mx-auto text-center mb-16">
                    ...
                    <h2 class="font-bold text-black sm:text-md text-sm mb-8 lg:text-sm"> <a href="/"
                    ...
                    <div class="w-full px-4 lg:w-1/2 xl:w-1/3 mb-5">
                        <div class="bg-white  rounded-xl shadow-lg overflow-hidden ">
                            <div class="py-8 px-6">
                                <div id="default-carousel" class="relative w-full" data-carousel="slide">
                                    <div class="relative h-56 overflow-hidden rounded-md ">
                                        <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                            <img src="{{ Storage::url($item->ab_foto) }}"
                                ...
                                <h3>
                                    <a href=" "
                                        class="block mb-3 mt-3 font-semibold text-xl text-black hover:text-primary truncate">{{ $item->ab_nama }}</a>
                                </h3>
                                <div class="flex mb-2">
                                    ...
                                    <p class="text-sm font-semibold ml-1"> qty</p>
                                    <sup class="text-xs text-gray-500"> Buah </sup>
                                </div>
                            </div> -->
                            <p class="text-xs text-gray-500 mb-1  flex justify-between">*check out 12.00 a.m <span
                                    class=" text-black font-bold text-base">Rp.
                                    {{ number_format($item->ab_tarif, 0, ',', '.') }} </span></p>
                            <p class=" text-sm text-gray-500 mb-1 float-right ">
                                {{ $item->satuanAlatBarangs->sab_nama }}</p>
                            <a href="{{ route('alat-barang.detail', $item->ab_slug) }}"
