        ...
        <div class=" container  ">
            ...
            <div class="flex xl:flex-row md:flex-row lg:flex-row flex-col justify-center space-x-2">
                ...
                <x-layout-detail-transaksi
                    ...
                    {{-- <img src="{{ Storage::url($layanan->l_foto) }}"
                        class="rounded-md shadow-lg w-[40rem] h-80 object-cover" alt=""> --}}

                    <x-multiple-image>
                        <x-sub-multiple-image src="{{ $layanan->l_foto }}" />
                        @foreach ($layanan->detailFotoLayanans as $image)
                            <x-sub-multiple-image src="{{ $image->dfl_foto }}" />
                        @endforeach
                    </x-multiple-image>
                        ...
                        <div class="flex-col space-y-2 w-full">
                            ...
                            <div class=" bg-white p-3 rounded-md">
                                <ul class="text-gray-500 text-sm ">
                                    <div class="flex mb-2">
                                        <p class="text-sm font-semibold ml-2">{{ $layanan->l_ukuran_gedung }}</p>
                                        <sup class="text-xs text-gray-500"></sup>
                                    </div>
                                    <div class="flex mb-2">
                                        <p class="text-sm font-semibold ml-1">{{ $layanan->l_kapasitas_gedung }}</p>
            ...
            <x-layout-detail-transaksi class="mt-5">
                <div class="mt-4 font">
                    <p class="text-base font-bold">Tentang {{ $layanan->l_nama }}</p>
                    <div class="mt-5 mb-5">
                        {!! $layanan->l_deskripsi !!}
                    </div>
...
@section('script')
    ...
    <script src="{{ asset('js/validasi/layanan.js') }}"></script>
@endsection
