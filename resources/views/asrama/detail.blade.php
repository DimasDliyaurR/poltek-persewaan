        ...
        <div class=" container  ">
            ...
            <div class="flex xl:flex-row md:flex-row lg:flex-row flex-col justify-center space-x-2">
                ...
                <x-layout-detail-transaksi
                    ...
                    <div class="basis-3/5 h-3/4 flex flex-row gap-4 rounded-md p-4 mb-2 ml-2 ">
                        <div class="flex-col space-y-2 w-full">
                            <p class="font-bold text-4xl"> {{ $tipeAsrama->ta_nama }}</p>
                            <p class="text-primary font-bold text-2xl">Rp
                                {{ number_format($tipeAsrama->ta_tarif, 0, ',', '.') }}

                            <div class=" bg-white p-3 rounded-md">
                                @foreach ($tipeAsrama->fasilitasAsramas as $fasilitas)
                                    <ul class="text-gray-500 text-sm ">
                                        <div class="flex mb-2">
                                            <box-icon name="{{ $fasilitas->fa_icon }}"></box-icon>
                                            <sup class="text-xs text-gray-500 ml-1">{{ $fasilitas->fa_nama }}</sup>
                                        </div>
                                    </ul>
                                @endforeach
                            </div>
                            <div class=" bg-white p-3 rounded-md">
                                {{-- <p class="text-xs text-gray-400"> * belum termasuk voucher</p><a
                                    href="{{ route('asrama.pesan', $tipeAsrama->ta_slug) }}"
                        ...
                        <a {{-- href="{{ route('asrama.pesan', $asrama->a_slug) }}" --}} id="asrama-option" onclick="dropdown_form(this)"
                            ...
                            <div
                                ...
                                <svg class="text-primary text-2xl" xmlns="http://www.w3.org/2000/svg" width="1em"
                                    ...
                                    <path fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="32" d="m272 336l80-80l-80-80M48 256h288" />
                                </svg>
                            </div>
                        </a>
                        {{-- Card End --}}
                    @empty
                        <p class="w-full text-center">Kamar tidak ada. Hubungi admin</p>
                    @endforelse
            ...
            <x-layout-detail-transaksi class="mt-5">
                <div class="mt-4 font">
                    <p class="text-base font-bold">Tentang {{ $tipeAsrama->ta_nama }}</p>
                    <div class="mt-5 mb-5">
