...
namespace App\Repositories\GedungLap\DetailTransaksiPropertyGedung;

use App\Models\DetailTransaksiPropertyGedung;

class DetailTransaksiPropertyGedungRepositoryImplement implements DetailTransaksiPropertyGedungRepository
{
    private $gedung;

    public function __construct(DetailTransaksiPropertyGedung $gedung)
    {
        $this->gedung = $gedung;
    }
